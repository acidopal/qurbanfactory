...
INSERT INTO `city` (`id_city`, `id_province`, `name`) VALUES
...
CREATE TABLE `delivery_info` (
  `id_delivery_info` int(11) NOT NULL,
  `id_transaction` int(11) NOT NULL,
  `sender_phone` int(14) NOT NULL,
  `consignee_phone` int(14) NOT NULL,
  `delivery_date` datetime NOT NULL,
  `arrival_estimation` datetime NOT NULL,
...
ALTER TABLE `delivery_info`
  ADD PRIMARY KEY (`id_delivery_info`),
...
ALTER TABLE `detail_transaction`
  ...
  ADD KEY `id_product` (`id_product`),
  ADD KEY `detail_transaction_ibfk_2` (`id_transaction`);
...
--
ALTER TABLE `delivery_info`
  MODIFY `id_delivery_info` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `city`
  ADD CONSTRAINT `city_ibfk_1` FOREIGN KEY (`id_province`) REFERENCES `province` (`id_province`);

--
-- Constraints for table `delivery_info`
--
ALTER TABLE `delivery_info`
  ADD CONSTRAINT `delivery_info_ibfk_1` FOREIGN KEY (`id_transaction`) REFERENCES `transaction` (`id_transaction`);

--
-- Constraints for table `detail_transaction`
--
ALTER TABLE `detail_transaction`
  ADD CONSTRAINT `detail_transaction_ibfk_1` FOREIGN KEY (`id_product`) REFERENCES `product` (`id_product`),
  ADD CONSTRAINT `detail_transaction_ibfk_2` FOREIGN KEY (`id_transaction`) REFERENCES `transaction` (`id_transaction`);

--
-- Constraints for table `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`id_product_category`) REFERENCES `product_categories` (`id_product_category`);
...
--
ALTER TABLE `user_address`
  ADD CONSTRAINT `user_address_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`),
  ADD CONSTRAINT `user_address_ibfk_2` FOREIGN KEY (`id_city`) REFERENCES `city` (`id_city`);
COMMIT;
